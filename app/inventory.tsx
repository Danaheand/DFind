      ...
      >
        <View style={styles.modalContainer}>
          <View style={[styles.modalContent, { backgroundColor: '#FFF' }]}>
            <Text style={[styles.modalTitle, { color: '#4b6154' }]}>Añadir Propiedad</Text>
            <TextInput
            ...
            <View style={styles.modalButtons}>
              ...
              >
                <Text style={[styles.cancelButtonText, { color: '#4b6154' }]}>Cancelar</Text>
              </Pressable>
              <Pressable
                style={[styles.saveButton, { backgroundColor: '#64ac8f' }]}
                onPress={addProperty}
              >
                <Text style={[styles.saveButtonText, { color: '#FFF' }]}>Guardar</Text>
              </Pressable>
            </View>
          </View>
        </View>
